...
def load_data():
    ...
    train_notes  = 'C:/Users/jonny/Uni/Year 4/Project/Python/8_bar_data/train_notes_18.npy'
    test_notes   = 'C:/Users/jonny/Uni/Year 4/Project/Python/8_bar_data/test_notes_2.npy'
    train_chords = 'C:/Users/jonny/Uni/Year 4/Project/Python/8_bar_data/train_chords_18.npy'
    
    X_tr = np.load(train_notes)            #X_tr = np.load('your training x')
    prev_X_tr = np.load(test_notes)        #prev_X_tr = np.load('your training prev x')
#    X_tr = X_tr.reshape(144,1,16,128)
#    prev_X_tr = prev_X_tr.reshape(16,1,16,128)
    ...
    kwargs = {'num_workers': 1, 'pin_memory': True}# if args.cuda else {} num_workers:4
...
def main():
    ...
    if is_draw == 1:
        ...
        plt.xlabel('data')
        plt.ylabel('loss')
        plt.savefig('C:/Users/Jon/Uni/Year 4/Project/Python/lr='+ str(lr) +'_epoch='+str(epochs)+'.png')

    if is_sample == 1:
        batch_size = 8
        nz = 100
        n_bars = 7
        ''' I need to have a play around with this '''
        X_te = np.load('C:/Users/Jon/Uni/Year 4/Project/Python/8_bar_data/monophonic_8bar_1.npy')
        prev_X_te = np.load('C:/Users/Jon/Uni/Year 4/Project/Python/8_bar_data/monophonic_8bar_0.npy')
        prev_X_te = prev_X_te[:,:,check_range_st:check_range_ed,:]
        y_te    = np.load('C:/Users/Jon/Uni/Year 4/Project/Python/8_bar_data/chord_1.npy')
        ...
        netG.load_state_dict(torch.load('model.py'))
