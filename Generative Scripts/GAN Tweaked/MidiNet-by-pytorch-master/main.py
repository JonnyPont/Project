...
def load_data():
    ...
    # X_tr = X_tr.reshape(14400,1,16,128)
    # prev_X_tr = prev_X_tr.reshape(14400,1,16,128)
    # # X_tr = np.random.rand(144,1,16,128)
    # # prev_X_tr = np.random.rand(144, 1, 16 ,128)
    # # chords = np.random.rand(14400, 13)
    # chords = np.load(train_chords)
    # y_tr = np.zeros([14400,13])

    X_tr        = np.load(train_notes)
    ...
    kwargs = {'num_workers': 0, 'pin_memory': False}# if args.cuda else {} num_workers:4
...
def main():
    ...
    if is_sample == 1:
        ...
        X_te = np.load('C:/Users/jonpo/Uni/Year 4/Project/Data/monophonic_8bar_0.npy')
        X_te = X_te.reshape(8,1,16,128)
        prev_X_te = np.load('C:/Users/jonpo/Uni/Year 4/Project/Data/monophonic_prev8bar_0.npy')
        prev_X_te = prev_X_te.reshape(8,1,16,128)
        prev_X_te = prev_X_te[:,:,check_range_st:check_range_ed,:]
        y_te    = np.load('C:/Users/jonpo/Uni/Year 4/Project/Data/chord_0.npy')
